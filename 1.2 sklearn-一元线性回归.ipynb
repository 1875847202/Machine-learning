{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "x_data = data[:,0,np.newaxis]  #变成二维张量\n",
    "print(x_data.shape)"
   ]
  },
  {
   ...
   "source": [
    ...
    "model.fit(x_data,y_data)    #数据以二维格式传入"
   ]
  },
  {
   "cell_type": "code",
